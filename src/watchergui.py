...
if __name__ == '__main__':  
    ...
    repobtn.grid(row=1, column=5,  sticky=W,padx=10)
    button1.grid(row=3, column=5, sticky=W,padx=10)
    ...
    lbDir.grid(row=1, column=3,sticky=W)
    lbBranch = Label(text="Branch" ,fg="green",bg="gray10",font = "Helvetica 10 bold")
    lbBranch.grid(row=3, column=3,sticky=W)
    mainloop()   
